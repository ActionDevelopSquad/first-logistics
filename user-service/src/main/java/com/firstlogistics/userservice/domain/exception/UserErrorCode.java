...
public enum UserErrorCode implements ErrorCode {
    ...
    SAME_ROLE_SELECTED(HttpStatus.BAD_REQUEST, "USER_400_006", "현재 권한과 수정된 권한이 동일합니다."),
    ...
    REFRESH_TOKEN_NOT_FOUND(HttpStatus.NOT_FOUND, "USER_404_002", "refresh token이 없습니다."),
